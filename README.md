...
> Explore yoga with personnalized routines :massage:

Yoguide is a personnal assistant that generates yoga routines adapted to your needs and mood. It also introduces new asanas and practice cues as you progress, to keep the exercise fresh and motivating.

* Free software: MIT
* Documentation: https://yoguide.readthedocs.io.
...
[appveyor-shield]: https://ci.appveyor.com/api/projects/status/github/moodule/yoguide?branch=master&svg=true
[appveyor-link]: https://ci.appveyor.com/project/moodule/yoguide/branch/master
...
[docs-link]: https://yoguide.readthedocs.io/en/latest/?badge=latest
[pypi-shield]: https://img.shields.io/pypi/v/yoguide.svg
[pypi-link]: https://pypi.python.org/pypi/yoguide
[pyup-shield]: https://pyup.io/repos/github/moodule/yoguide/shield.svg
[pyup-link]: https://pyup.io/repos/github/moodule/yoguide/
[release-shield]: https://img.shields.io/badge/release-v0-blue.svg?longCache=true
[travis-shield]: https://img.shields.io/travis/moodule/yoguide.svg
[travis-link]: https://travis-ci.org/moodule/yoguide
